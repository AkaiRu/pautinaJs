...
document.addEventListener('keydown', function(event){
    ...
    if(event.key == 'ArrowUp'){
        ...
        box1.style.boxShadow = `0 0 5px rgb(255, 255, 240)`
    }
    if(event.key == 'ArrowLeft'){
        box1.style.left = box1.offsetLeft - 1 + 'px'
        box1.style.boxShadow = `0 0 5px rgb(255, 34, 176)`
    }
    if(event.key == 'ArrowRight'){
        box1.style.left = box1.offsetLeft + 1 + 'px'
        box1.style.boxShadow = `0 0 5px rgb(168, 94, 240)`
    }
    if(event.key == 'ArrowDown'){
        box1.style.top = box1.offsetTop + 1 + 'px'
        box1.style.boxShadow = `0 0 25px rgb(0, 166, 250)`
    }
})
